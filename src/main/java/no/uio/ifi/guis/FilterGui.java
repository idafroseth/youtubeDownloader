...
//				}
				...
				progressPanel.setLayout(new FlowLayout());//(FlowLayout.CENTER, 3, 10));
				...
				progressDialog.setLocation((Toolkit.getDefaultToolkit().getScreenSize().width)/2 - getWidth()/2, (Toolkit.getDefaultToolkit().getScreenSize().height)/2 - getHeight()/2);
